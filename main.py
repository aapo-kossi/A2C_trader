...
def main():
    ...
    parser.add_argument('-d', '--input_dir',
                        help='path to the dir including processed csv split into train, eval and test dirs', type=str)
    parser.add_argument('-v', '--verbose',
                        help='use this flag if you want logs detailing training progress while running',
                        action='store_true')
